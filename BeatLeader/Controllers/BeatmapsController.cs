...
namespace BeatLeader.Controllers
{
    public class BeatmapsController : Controller
    {
        ...
        {
            var beatLeaderContextDb = _context.Beatmap.Include(b => b.song);
            return View(await beatLeaderContextDb.ToListAsync());
        }
