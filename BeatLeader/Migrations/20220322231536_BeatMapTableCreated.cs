...
namespace BeatLeader.Migrations
{
    public partial class BeatMapTableCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SongName = table.Column<string>(type: "nvarchar(1)", nullable: false),
                    SongLength = table.Column<int>(type: "int", nullable: false),
                    SongBPM = table.Column<int>(type: "int", nullable: false),
                    Size = table.Column<int>(type: "int", nullable: false),
                    Artist = table.Column<string>(type: "nvarchar(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rank = table.Column<string>(type: "nvarchar(1)", nullable: false),
